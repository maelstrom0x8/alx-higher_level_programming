...
class TestRectangle(unittest.TestCase):
    ...
    def test_width_property(self):
        # Test that width property works as expected
        rect = Rectangle(5, 10)
    ...
    def test_height_property(self):
        # Test that height property works as expected
        rect = Rectangle(5, 10)
    ...
    def test_x_property(self):
        # Test that x property works as expected
    ...
    def test_y_property(self):
        # Test that y property works as expected
        rect = Rectangle(5, 10, 3, 4)
    ...
    def test_str_method(self):
        # Test the str method
        rect = Rectangle(5, 10, 2, 2, 1)
        expected_output = "[Rectangle] (1) 2/2 - 5/10"
        self.assertEqual(str(rect), expected_output)

    def test_to_dictionary_method(self):
        # Test the to_dictionary method
        rect = Rectangle(5, 10, 2, 2, 1)
        expected_dict = {'id': 1, 'width': 5, 'height': 10, 'x': 2, 'y': 2}
        self.assertEqual(rect.to_dictionary(), expected_dict)


class RectangleWithInvalidArguments(unittest.TestCase):

    def test_create_rectangle_with_invalid_dimension(self):
        # Creating rectangle object with invalid dimensions
        with self.assertRaises(TypeError) as ctx:
            r1 = Rectangle('12', '21')

        self.assertTrue('width must be an integer' in ctx.exception.__str__())

    def test_create_rectangle_with_none_arg(self):
        with self.assertRaises(Exception) as ctx:
            r2 = Rectangle(None)

        self.assertFalse('yay' in ctx.exception.__str__())
